...
VanetRoutingExperiment::VanetRoutingExperiment ()
  : m_port (9),
    m_CSVfileName ("vanet-routing-routing1.csv"),
    m_CSVfileName2 ("vanet-routing-routing2.csv"),
    m_nSinks (10),
...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
  ...
  else if (m_scenario == 2)
    {
      ...
      // "low density, 70 total vehicles"
      m_traceFile = "/home/veins/src/sumo/docs/tutorial/CN/map/vanetmobility_main.tcl";
      m_logFile = "vanet_main.log";
      m_mobility = 1;
      m_nNodes = 70;
      m_TotalSimTime = 100.00;
      m_nodeSpeed = 0;
      m_nodePause = 0;
      m_CSVfileName = "s2vanet-routing_main1.csv";
      m_CSVfileName = "s2vanet-routing_main2.csv";
    }
}
